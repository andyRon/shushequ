...
import top.andyron.shushequ.api.model.enums.ArticleTypeEnum;
import top.andyron.shushequ.api.model.enums.PushStatusEnum;
import top.andyron.shushequ.api.model.enums.SourceTypeEnum;
...
public class ArticlePostReq implements Serializable {
     ...
     * 状态：0-未发布，1-已发布
     *
     * @see top.andyron.shushequ.api.model.enums.PushStatusEnum
     */
