package top.andyron.shushequ.core.util.id;

import top.andyron.shushequ.api.model.enums.pay.ThirdPayWayEnum;
import top.andyron.shushequ.core.async.AsyncUtil;
import top.andyron.shushequ.core.util.CompressUtil;
import top.andyron.shushequ.core.util.DateUtil;
import top.andyron.shushequ.core.util.id.snowflake.PaiSnowflakeIdGenerator;
import top.andyron.shushequ.core.util.id.snowflake.SnowflakeProducer;
import org.apache.commons.lang3.StringUtils;

import java.util.concurrent.atomic.AtomicLong;

import static top.andyron.shushequ.core.util.CompressUtil.int2str;
