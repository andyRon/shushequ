package top.andyron.shushequ.service.chatai.service.impl.ali;
...
api.model.enums.ChatAnswerTypeEnum;
api.model.enums.ai.AiChatStatEnum;
api.model.vo.chat.ChatItemVo;
api.model.vo.chat.ChatRecordsVo;
core.util.JsonUtil;
...
public class AliIntegration {
    ...
    public boolean directReturn(Long user, ChatItemVo chat) {
        return directReturn(user, Arrays.asList(chat), chat);
    }
