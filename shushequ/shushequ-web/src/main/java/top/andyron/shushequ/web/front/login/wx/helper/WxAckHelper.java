package top.andyron.shushequ.web.front.login.wx.helper;

import top.andyron.shushequ.api.model.vo.user.wx.BaseWxMsgResVo;
import top.andyron.shushequ.api.model.vo.user.wx.WxImgTxtItemVo;
import top.andyron.shushequ.api.model.vo.user.wx.WxImgTxtMsgResVo;
import top.andyron.shushequ.api.model.vo.user.wx.WxTxtMsgResVo;
import top.andyron.shushequ.api.model.vo.wx.menu.WxMenuPreviewAiReq;
import top.andyron.shushequ.api.model.vo.wx.menu.WxMenuReplyArticleDTO;
import top.andyron.shushequ.api.model.vo.wx.menu.WxMenuReplyDTO;
import top.andyron.shushequ.core.async.AsyncUtil;
import top.andyron.shushequ.core.util.CodeGenerateUtil;
